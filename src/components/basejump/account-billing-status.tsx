  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>A quick overview of your billing status</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <CardFooter>
          <form className="w-full">
            ...
            {data.status === "not_setup" ? (
              <SubmitButton pendingText="Loading..." formAction={setupNewSubscription}>
                Setup your Subscription
              </SubmitButton>
            ) : (
              <SubmitButton pendingText="Loading..." formAction={manageSubscription}>
                Manage Subscription
              </SubmitButton>
            )}
          </form>
